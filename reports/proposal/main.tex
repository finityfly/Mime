...
\documentclass[letterpaper,8pt,titlepage,oneside,final]{book}
...
\hypersetup{
    ...
    pdftitle={Group 10 Proposal},    % title: CHANGE THIS TEXT!
    pdfauthor={Daniel\ Lu\ &\ Methira\ Herath},    % author: CHANGE THIS TEXT! and uncomment this line
    pdfsubject={COMP\ 4107},  % subject: CHANGE THIS TEXT! and uncomment this line
...
\setlength{\evensidemargin}{0.05in} % Adds 1/8 in. to binding side of all 
% even-numbered pages when the "twoside" printing option is selected
\setlength{\oddsidemargin}{0.05in} % Adds 1/8 in. to the left of all pages when "oneside" printing is selected, and to the left of all odd-numbered pages when "twoside" printing is selected
\setlength{\textwidth}{6.7in} % assuming US letter paper (8.5 in. x 11 in.) and side margins as above
\raggedbottom
...
\fancypagestyle{plain}{%
    \fancyhf{}%
    \fancyfoot[R]{\vspace{0.5cm}\thepage}%
}
