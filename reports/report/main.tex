...
\documentclass[letterpaper,10pt,titlepage,oneside,final]{book}
...
\hypersetup{
    ...
    pdftitle={COMP4107\ Project\ Report:\ Mime},    % title: CHANGE THIS TEXT!
    pdfauthor={Daniel\ Lu\ and\ Methira\ Herath},    % author: CHANGE THIS TEXT! and uncomment this line
...
\setlength{\evensidemargin}{0.11in} % Adds 1/8 in. to binding side of all 
% even-numbered pages when the "twoside" printing option is selected
\setlength{\oddsidemargin}{0.11in} % Adds 1/8 in. to the left of all pages when "oneside" printing is selected, and to the left of all odd-numbered pages when "twoside" printing is selected
...
\fancypagestyle{plain}{%
    \fancyhf{}%
    \fancyfoot[R]{\vspace{0.2cm}\thepage}%
}

% Remove all chapter title vertical spacing
...
% This should be MAX 10 pages long
